...
import { deletePost, deleteProject } from "@/lib/actions";
  ...
  return (
    <form
      action={async (data: FormData) =>
        window.confirm("Are you sure you want to delete your project?") &&
        deleteProject(data, id, "delete").then((res) => {
          if (res.error) {
            toast.error(res.error);
          } else {
            va.track("Deleted Project");
            router.refresh();
            router.push(`/agency/${res.agencyId}`);
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 sm:p-10">
        ...
        <p className="text-sm text-stone-500 dark:text-stone-400">
          Deletes your project permanently. Type in the name of your project{" "}
